...
v = st.write(""" <h2> <b style="color: rgb(255, 75, 75)">🎥 MoviesWay</b> </h2>""",unsafe_allow_html=True)
# st.header(v)
# st.header(" :red[MoviesWay]")
st.write("###")

st.write(""" <p> Hii, welcome to <b style="color: rgb(255, 75, 75)">Moviesway</b> this free movie recommendation engine suggests films based on your interest </p>""",unsafe_allow_html=True)
st.write("##")
